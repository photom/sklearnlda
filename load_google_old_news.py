...
GOOGL_RSS_URL_TMP = "https://www.google.com/finance/company_news?q=NASDAQ%3A{ticker}&output=rss&start=0&num=2000"
NEWS_DIR = "news"
...
def main():
    ticker_raw = "GOOGL"
    response = feedparser.parse(GOOGL_RSS_URL_TMP.format(ticker=ticker_raw))
